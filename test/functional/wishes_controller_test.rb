...
class WishesControllerTest < ActionController::TestCase
  ...
  test "should create wish" do
    assert_difference('Wish.count') do
      post :create, wish: { notes: @wish.notes, secret: @wish.secret, taken_by: @wish.taken_by, title: @wish.title, url: @wish.url }
    end
  ...
  test "should update wish" do
    put :update, id: @wish, wish: { notes: @wish.notes, secret: @wish.secret, taken_by: @wish.taken_by, title: @wish.title, url: @wish.url }
    assert_redirected_to wish_path(assigns(:wish))
  end
